			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					...
					@include('admin.alert')
						...
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="password" placeholder="Your Email Password">
						</div>
						<div class="m-b-30">
						<a href="/registrationuser">Đăng Kí</a>
						</div>
