					...
					<div class="p-r-45 p-r-0-lg" style="  text-align: center;">
						...
						<div class="p-t-140">
							...
							@endif
								...
								<div class="bor19 m-b-20" >
									<input class="stext-111 cl2 plh3 size-124 p-lr-18" type="text" name="name" placeholder="Name" style="min-height: 50px;">
								</div>

								<div class="bor19 m-b-20" >
									<input class="stext-111 cl2 plh3 size-124 p-lr-18" type="text" name="address" placeholder="address" style="min-height: 50px;">
								</div>

								<div class="bor19 m-b-20" >
									<input class="stext-111 cl2 plh3 size-124 p-lr-18" type="number" name="phone" placeholder="phone" style="min-height: 50px;">
								</div>
                                <div class="bor19 m-b-20" >
									<input class="stext-111 cl2 plh3 size-124 p-lr-18" type="email" name="email" placeholder="email" style="min-height: 50px;">
								</div>
                                <div class="bor19 m-b-20" >
									<div style="font-size: 16px; color: #333;margin-right:500px;">
                                    <label><input style="margin-left: 10px;" type="radio" name="id_payment" value="1"> Thanh toán tiền mặt</label><br>
                                	<label><input type="radio" name="id_payment" value="2"> Thanh toán momo</label>
									</div>
								</div>
                                <div class="bor19 m-b-20">
