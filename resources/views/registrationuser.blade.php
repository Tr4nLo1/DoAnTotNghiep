				...
				<div class="col-md-7 col-lg-8">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="name" placeholder="Tên của bạn">
						</div>
                        @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
						<div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="email" name="email" placeholder="Email của bạn">
						</div>
                        @error('password')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="password" placeholder="Mật khẩu của bạn">
						</div>
                        @error('phone')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="numberphone" name="phone" placeholder="Số điện thoại của bạn">
						</div>
                        @error('address')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="address" placeholder="Địa chỉ của bạn">
						</div>
						<div class="bor8 m-b-30">
						<input type="radio" name="sex" checked="" value="1" style="margin-left: 60px;"><label >Nam</label><br>
						<input type="radio" name="sex"  value="0" style="margin-left: 60px;"><label >Nữ</label>
						</div>
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="hidden" name="active"  value="1">
